...
# # #         /* Estilo dos Cards na Sidebar - Versão Compacta e Elegante */
# # #         .sidebar-nav-card {
# # #             background: rgba(30, 41, 59, 0.4);
# # #             border: 1px solid #334155;
# # #             border-radius: 10px;
...
# # #         }
# # #         .sidebar-nav-card span { font-size: 1.4rem; }
...
# # #     # SIDEBAR (Com a nova organização sugerida)
# # #     with st.sidebar:
...
# # #             api_key = st.text_input("Groq Cloud Key", type="password", label_visibility="collapsed")
# # #             if api_key: st.session_state.key = api_key
            
# # #             modelo = st.selectbox("Modelo de IA", ["llama-3.3-70b-versatile", "llama-3.1-8b-instant"])
# # #             st.session_state.mod = modelo

# # #         # 2. ATALHOS DE SUPORTE (Movidos para preencher o espaço vazio)
# # #         st.write("")
# # #         st.markdown("**🚀 Atalhos Rápidos**")
# # #         st.markdown("""
# # #             <a href="https://youtu.be/2wPQVni6A6s" target="_blank" class="sidebar-nav-card"><span>📺</span><label>Tutorial</label></a>
# # #             <a href="https://forms.gle/yXDhJu74r2Cq4zbi9" target="_blank" class="sidebar-nav-card"><span>⭐</span><label>Avaliar Plataforma</label></a>
# # #             <a href="https://wa.me/message/FRVFVIUBESLVD1" target="_blank" class="sidebar-nav-card"><span>💬</span><label>Suporte Técnico</label></a>
# # #             <a href="https://youtu.be/7c5yfAdmIEQ" target="_blank" class="sidebar-nav-card"><span>💡</span><label>Dicas de Carreira</label></a>
# # #         """, unsafe_allow_html=True)
...
# # #     col_main, col_widgets = st.columns([2.2, 1], gap="large")
...
# # #     with col_widgets:
# # #         st.write("")
# # #         # Área superior direita apenas para o vídeo/arte
# # #         st.markdown('<div class="media-container">', unsafe_allow_html=True)
# # #         st.video("meu_video.mp4", autoplay=True, loop=True, muted=True)
# # #         st.markdown('</div>', unsafe_allow_html=True)
        
# # #         # Dica útil isolada
# # #         st.info("💡 **Dica Técnica:** Quanto mais detalhados forem os requisitos da vaga, mais preciso será o ranking de aderência gerado pela IA.")
...
# #         /* Estilo dos Cards na Sidebar - Versão ULTRA COMPACTA */
# #         .sidebar-nav-card {
# #             background: rgba(30, 41, 59, 0.4);
# #             border: 1px solid #334155;
# #             border-radius: 8px;
...
# #         }
# #         .sidebar-nav-card span { font-size: 1.1rem; }
# #         .sidebar-nav-card label { 
# #             color: #F1F5F9; 
# #             font-weight: 500; 
# #             cursor: pointer; 
...
# #         /* Ajuste do espaçamento da sidebar */
# #         section[data-testid="stSidebar"] .stMarkdown h3 {
# #             margin-bottom: 0.5rem;
# #         }
...
# #         # 2. VÍDEO (Agora na Sidebar para liberar a direita)
# #         st.write("")
# #         st.markdown("**🎥 Visão do Projeto**")
# #         st.markdown('<div class="sidebar-video-box">', unsafe_allow_html=True)
# #         st.video("meu_video.mp4", autoplay=True, loop=True, muted=True)
# #         st.markdown('</div>', unsafe_allow_html=True)
...
# #         st.markdown("""
# #             <a href="https://youtu.be/2wPQVni6A6s" target="_blank" class="sidebar-nav-card"><span>📺</span><label>Tutorial</label></a>
# #             <a href="https://forms.gle/yXDhJu74r2Cq4zbi9" target="_blank" class="sidebar-nav-card"><span>⭐</span><label>Avaliar</label></a>
# #             <a href="https://wa.me/message/FRVFVIUBESLVD1" target="_blank" class="sidebar-nav-card"><span>💬</span><label>Suporte</label></a>
# #             <a href="https://youtu.be/7c5yfAdmIEQ" target="_blank" class="sidebar-nav-card"><span>💡</span><label>Dicas</label></a>
# #         """, unsafe_allow_html=True)
...
# #     if btn:
# #         if not st.session_state.get('key'): st.error("Insira sua chave API na barra lateral.")
# #         elif not arquivos: st.warning("Suba os currículos primeiro.")
# #         else:
# #             progresso = st.progress(0)
# #             resultados = []
...
#         /* Moldura do Vídeo Estilo GIF na Sidebar */
#         .sidebar-video-box {
#             border-radius: 12px;
#             overflow: hidden;
#             border: 1px solid #1E293B;
...
#     """Lê um vídeo local e o renderiza como um GIF (sem controles)"""
#     try:
...
#         # 1. VÍDEO COMO GIF (Nova configuração técnica)
#         st.write("")
